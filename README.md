...
# FlowTask - Task Management System

A modern task management system built with Laravel, featuring role-based access control, time tracking, and comprehensive reporting.
...
For detailed installation instructions, see [INSTALLATION.md](INSTALLATION.md) or [INSTALLER_README.md](INSTALLER_README.md).

## ✨ Features

- **Role-Based Access Control** - Admin, Staff, and Superadmin roles
...
- [Installer Documentation](INSTALLER_README.md) - Auto-installer details
- [CLI Installer](cli-installer/README.md) - NPM package documentation
